...
class VisitedChemistDetailSheetWidget extends StatefulWidget {
  const VisitedChemistDetailSheetWidget({
    Key key,
    this.currentChemist,
  }) : super(key: key);

  final String currentChemist;

  @override
  _VisitedChemistDetailSheetWidgetState createState() =>
      _VisitedChemistDetailSheetWidgetState();
}

class _VisitedChemistDetailSheetWidgetState
              ...
              children: [
                ...
                FFButtonWidget(
                  onPressed: () async {
                    await showDialog(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          ...
                          content: Text(
                              'All data for this chemist will be permanently logged'),
                          actions: [
                            TextButton(
                              onPressed: () =>
                            ...
                            TextButton(
                              onPressed: () async {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Commited all chemist data for ${widget.currentChemist}',
                                      style: TextStyle(),
                                    ),
                    ...
                    await actions.finishChemistDetail(
                      FFAppState().selectedChemistPOPs.toList(),
                      FFAppState().selectedChemistBooking.toList(),
                    );
